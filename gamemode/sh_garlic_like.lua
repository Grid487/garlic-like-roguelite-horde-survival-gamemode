...
tbl_gl_character_stats = {
    ...
    [2] = {
        ...
        shop_upgrade_price_increase = 30000,
    }, 
    [3] = {
        name = "Bonus Damage",
        id = gl .. "bonus_damage",
    ...
    [4] = {
        ...
        shop_upgrade_price_increase = 6000,
    }, 
    [5] = {
    ...
    [8] = {
        ...
        shop_upgrade_base_price = 3000,
        shop_upgrade_price_increase = 9000,
    }, 
    [9] = {
        name = "Block Chance",
    ...
    [17] = {
        ...
        shop_upgrade_amount = 0.1,
        shop_upgrade_base_price = 25000,
        shop_upgrade_price_increase = 65000,
...
tbl_gl_enemy_modifiers = { 
    ...
    ["BLEED"] = {
        ...
        tbl_txt = {
            [1] = "Enemy hits deal 12% of the damage originally dealt every 0.5 second over 10 seconds.",
...
tbl_gl_elements = {
    [1] = {
        ...
        tbl_txt = {
            ...
            [3] = "fire element weapon increases the burn duration by 1 second, up to 10 seconds.",
            [4] = "",
            [5] = "The fire deals (1% of the enemy's health)^(1 + seconds left / 2 * 0.01) damage,",
            [6] = "and damage is capped at (highest damage dealt to enemy) * 5. Every tick increases",
            [7] = "chance for the enemy to miss by %0.75. Enemy deals 15% reduced damage while ignited,",
            [8] = "every tick further reduces enemy damage dealt by %1 up to 75%.",
            w = 0, 
            h = 0,
        },
    ...
    [2] = {
        ...
        tbl_txt = {
            ...
            [3] = "every time the poison deals damage, it loses 33.3% of it's damage but",
            [4] = "applies a stacking 12.5% damage taken multiplier to the enemy,",
            [5] = "up to +250% damage taken multiplier.",
            [6] = "",
            [7] = "The poison deals 60% of it's damage to enemies next to the poisoned enemy.", 
            w = 0, 
            h = 0,
        },
    ...
    [3] = {
        ...
        tbl_txt = {
            ...
            [2] = "The shockwave deals 250% of the damage and is capable of creating another",
            ...
            [9] = "it took * 0.04). For every enemy that a shockwave hits, whether it be the initial or",
            [10] = "a chain, gives the player a buff stack and increases the player's damage by",
            [11] = "(1.045^buff stacks) up to +250% damage.",
            w = 0, 
            h = 0,
        },
